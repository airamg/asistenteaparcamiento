...
extern void          srf08_change_i2c_address(unsigned char old_i2c_address, unsigned char new_i2c_address);


// My additions
extern void start_ping(unsigned char metric_unit);
extern unsigned char check_ping(void);
extern unsigned int read_ping(void);
